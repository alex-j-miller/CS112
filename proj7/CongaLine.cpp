...
bool CongaLine::insertAfter(string otherPersonsName, string yourName) {
	return myLine.insertAfter(otherPersonsName, yourName);
}

bool CongaLine::insertBefore(string otherPersonsName, string yourName) {
	return myLine.insertBefore(otherPersonsName, yourName);
}
