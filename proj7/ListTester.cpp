...
void ListTester::testInsertAfter(){
	...
	l0.append(2);
	l0.insertAfter(0, 5);
	assert(l0.myFirst->myNext->myItem == 5);
	cout << "0" << flush;
	l0.insertAfter(2, 10);
	assert(l0.getLast() == 10);
	cout << "1" << flush;
...
void ListTester::testInsertBefore(){
	...
	l0.append(2);
	l0.insertBefore(0, 5);
	assert(l0.getFirst() == 5);
	cout << "0" << flush;
	l0.insertBefore(2, 10);
	assert(l0.myFirst->myNext->myNext->myNext->myItem == 10);
	cout << "1" << flush;
